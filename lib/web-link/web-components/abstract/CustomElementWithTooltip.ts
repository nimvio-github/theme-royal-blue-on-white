...
import { ElementPositionOffset } from './PositionedElement';

export abstract class CustomElementWithTooltip extends CustomElement {
  ...
  protected tooltipRef: TooltipElement | null = null;
  ...
  private showTooltip = (): void => {
    ...
    const tooltip = document.createElement(TooltipElement.is);
