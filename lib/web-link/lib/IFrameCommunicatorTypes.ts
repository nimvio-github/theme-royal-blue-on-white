...
export interface IContentComponentClickedMessageData
  extends IContentItemClickedMessageData {
...
interface IRelativeInsertPosition {
  ...
  readonly placement:
    ...
    | InsertPositionPlacement.After;
}

interface IFixedInsertPosition {
  readonly placement:
    | InsertPositionPlacement.Start
    | InsertPositionPlacement.End;
}
...
export interface IAddButtonPermissionsServerModel {
  ...
  readonly permissions: ReadonlyMap<
    AddButtonPermission,
